...
public class MainActivity extends AppCompatActivity implements NaverMap.OnMapClickListener, Overlay.OnClickListener, OnMapReadyCallback, NaverMap.OnCameraChangeListener, NaverMap.OnCameraIdleListener {
    ...
    public void onMapReady(@NonNull NaverMap naverMap) {
        ...
        naverMap.addOnCameraChangeListener(this);  // 지도를 움직였을때 지도 멈췄을때 우리에게 알려주는 리스너
        ...
        infoWindow.setAdapter(new InfoWindow.DefaultViewAdapter(this) {
            ...
            protected View getContentView(@NonNull InfoWindow infoWindow) {
                ...
                Store store = (Store) marker.getTag(); // getTag()로 가져온 Store 정보를 가지고 view_info_window.xml 를 가지고 view를 인플레이션
    ...
    @Override
    public boolean onClick(@NonNull Overlay overlay) { // 마커 클릭시 수행
